...
abstract class AppLocalizations {
  ...
  /// No description provided for @title_cant_be_empty.
  ///
  /// In en, this message translates to:
  /// **'Title can\'t be empty'**
  String get title_cant_be_empty;
  ...
  /// No description provided for @dynamic_colors.
  ///
  /// In en, this message translates to:
  /// **'Dynamic Colors'**
  String get dynamic_colors;

  /// No description provided for @dynamic_colors_description.
  ///
  /// In en, this message translates to:
